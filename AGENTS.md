...
- 2026-05-08, comparacao `HEAD..worktree`: o zoom narrativo virou uma cena mais travada no topo sem reordenar secoes: a secao real `#sobre` ganha `.is-about-locked` com `position: sticky` enquanto o `ScrollTrigger` esta ativo, preservando o fluxo antes de `#como-funciona`; a separacao interna do browser deixou de usar blur e a timeline foi retimada para revelar o About antes do fade final da mascara.
