...
- 2026-05-06, comparacao `HEAD..worktree`: o reveal da secao `#sobre` deixou de deslocar a section inteira; o fundo agora encaixa no topo do viewport, enquanto apenas `.about-mask-reveal__content` recebe translate leve, e o padding superior foi reduzido para manter respiro sem criar gap.
