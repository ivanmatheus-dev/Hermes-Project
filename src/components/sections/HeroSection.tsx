...
export function HeroSection({
  ...
  return (
    <section
      ref={heroRef}
      className="mineral-paper relative min-h-screen overflow-hidden bg-[var(--mineral)] text-[var(--charcoal)]"
    >
      <div
        ref={entryOverlayRef}
      ...
      <main
        id="top"
        className="relative z-10 mx-auto grid min-h-screen max-w-[78rem] items-end gap-8 px-5 pb-8 pt-28 md:grid-cols-[minmax(0,38.125rem)_minmax(24rem,37.125rem)] md:items-center md:justify-between md:px-10 md:pb-0 md:pt-24 lg:px-0"
      >
        ...
        <div className="order-3 md:order-none md:row-span-2 md:self-center">
          <div ref={mockupRef} className="ml-auto w-full max-w-[37.125rem] opacity-0">
            <BrowserMockup />
          </div>
        </div>
